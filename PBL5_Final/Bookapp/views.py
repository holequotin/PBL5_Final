...
def home(request):
    ...
    return render(request, 'home.html',{'recommended_books':recommended_books,'reading_book':reading_book,'grammar_books':grammar_books,
...
def book_list(request,number):
    ...
    return render(request,'Bookapp/book_list.html',context)
...
def edit_book(request,pk):
    ...
    return render(request,'Bookapp/edit_book_form.html',{'form' : form})